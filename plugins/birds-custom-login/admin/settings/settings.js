jQuery(document).ready(function ($) {
    ...
    $('.birds-settings-media', form).each(function () {
        var frame,
            select = $('.birds-select-media', this),
            remove = $('.birds-remove-media', this),
            input = $('input', this),
            preview = $('img', this),
    ...
    $('.birds-settings-action', form).each(function () {
    ...
    $('.birds-settings-color').wpColorPicker();
});
